...
#define FLIST_LOG 16
#endif
#define FLIST_SIZE (1<<FLIST_LOG)
#define FMASK ((unsigned int)FLIST_SIZE-1)
...
void freeFlist (LIST * flist[FLIST_SIZE])
{
    int i;
...
void mepsm_init ()
{
    ...
    memset (flist, 0, sizeof (LIST *) * FLIST_SIZE);
}
