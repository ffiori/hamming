...
//***** search *****
int search4(unsigned char *buf, int Tlen, int _, int qval)
{ 
...
int search8(unsigned char *buf, int Tlen, int _, int qval)
{
    unsigned char* charPtr = &buf[offset];
...
int search16(unsigned char *buf, int Tlen, int _, int qval)
{
    unsigned char* charPtr = &buf[offset];
...
int mepsm_exec(unsigned char *buf, int Tlen)
{
