...
results_file="../results-single-i7-19-09-17.txt"


echo "% DNA DNA DNA DNA DNA DNA DNA DNA DNA DNA DNA DNA\n"

for alg in "sa" "tusa" "twsa" "ans " "ansb" "ans2 " "ans2b " "ans2b-noif" "ef " "efs" "byp " "byps " "bypsb"; do
...
for alg in "sa" "tusa" "twsa" "ans " "ansb" "ans2 " "ans2b " "ans2b-noif" "byp " "byps " "bypsb"; do
